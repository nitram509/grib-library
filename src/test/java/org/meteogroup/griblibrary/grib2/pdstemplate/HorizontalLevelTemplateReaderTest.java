...
public class HorizontalLevelTemplateReaderTest {
     ...
     */
    private static final HorizontalLevelTemplate GOOD_HORIZONTALLEVEL_OBJECT() {
        ...
        horizontalLevelTemplate.setHoursOfObservation(asSignedInt((byte) 255, (byte) 255)); //not important yet
