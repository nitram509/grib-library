...
public class HorizontalLevelTemplateReader implements ProductTemplateReader {
    ...
    @Override
    public ProductTemplate readTemplate(byte[] pdsValues, int headerOffSet) {
        HorizontalLevelTemplate template = new HorizontalLevelTemplate();
        template.setParameterCategory((short) (pdsValues[POSITION_PARAMETER_CATEGORY + headerOffSet] & BytesToPrimitiveHelper.INT_BYTE_MASK));
        template.setParameterNumber((short) (pdsValues[POSITION_PARAMETER_NUMBER + headerOffSet] & BytesToPrimitiveHelper.INT_BYTE_MASK));
        template.setGeneratingProcess((short) (pdsValues[POSITION_TYPE_OF_GENERATING_PROCESS + headerOffSet] & BytesToPrimitiveHelper.INT_BYTE_MASK));
        template.setBackgroundGenerating((short) (pdsValues[POSITION_BACKGROUND_GENERATING_PROCESS_IDENTIFIER + headerOffSet] & BytesToPrimitiveHelper.INT_BYTE_MASK));
        template.setAnalysisProcess((short) (pdsValues[POSITION_ANALYSIS_OR_FORECAST_IDENTIFIED + headerOffSet] & BytesToPrimitiveHelper.INT_BYTE_MASK));
        template.setHoursOfObservation(BytesToPrimitiveHelper.asSignedInt(pdsValues[POSITION_HOURS_OF_OBSERVATION_DATA_CUTOFF_AFTER_REFERENCE_TIME_1 + headerOffSet], pdsValues[POSITION_HOURS_OF_OBSERVATION_DATA_CUTOFF_AFTER_REFERENCE_TIME_2 + headerOffSet]));
        template.setMinutesOfObservation((short) (pdsValues[POSITION_MINUTES_OF_OBSERVATION_DATA_CUTOFF_AFTER_REFERENCE_TIME + headerOffSet] & BytesToPrimitiveHelper.INT_BYTE_MASK));
        template.setUnitOfTimeRange((HorizontalLevelTemplate.HorizontalLevelTimeUnit.valueOf((pdsValues[POSITION_IDENTICATOR_OF_UNIT_OF_TIME_RANGE + headerOffSet] & BytesToPrimitiveHelper.INT_BYTE_MASK))));
        template.setForeCastTimeInTimeRange(asInt(pdsValues[POSITION_FORECAST_TIME_IN_UNIT_AS_DEFINED_1 + headerOffSet], pdsValues[POSITION_FORECAST_TIME_IN_UNIT_AS_DEFINED_2 + headerOffSet], pdsValues[POSITION_FORECAST_TIME_IN_UNIT_AS_DEFINED_3 + headerOffSet], pdsValues[POSITION_FORECAST_TIME_IN_UNIT_AS_DEFINED_4 + headerOffSet]));
        template.setTypeOfFirstFixedSurface((short) (pdsValues[POSITION_TYPE_OF_FIRST_FIXED_SURFACE + headerOffSet] & BytesToPrimitiveHelper.INT_BYTE_MASK));
        template.setScaleOfFirstFixedSurface((short) (pdsValues[POSITION_SCALE_FACTOR_OF_FIRST_FIXED_SURFACE + headerOffSet] & BytesToPrimitiveHelper.INT_BYTE_MASK));
        template.setScaleValueOfFirstFixedSurface(asInt(pdsValues[POSITION_SCALED_VALUE_OF_FIRST_FIXED_SURFACE_1 + headerOffSet], pdsValues[POSITION_SCALED_VALUE_OF_FIRST_FIXED_SURFACE_2 + headerOffSet], pdsValues[POSITION_SCALED_VALUE_OF_FIRST_FIXED_SURFACE_3 + headerOffSet], pdsValues[POSITION_SCALED_VALUE_OF_FIRST_FIXED_SURFACE_4 + headerOffSet]));
        template.setTypeOfSecondFixedSurface((short) (pdsValues[POSITION_TYPE_OF_SECOND_FIXED_SURFACE + headerOffSet] & BytesToPrimitiveHelper.INT_BYTE_MASK));
        template.setScaleOfSecondFixedSurface((short) (pdsValues[POSITION_SCALE_FACTOR_OF_SECOND_FIXED_SURFACE + headerOffSet] & BytesToPrimitiveHelper.INT_BYTE_MASK));
        template.setScaleValueOfSecondFixedSurface(asInt(pdsValues[POSITION_SCALED_VALUE_OF_SECOND_FIXED_SURFACE_1 + headerOffSet], pdsValues[POSITION_SCALED_VALUE_OF_SECOND_FIXED_SURFACE_2 + headerOffSet], pdsValues[POSITION_SCALED_VALUE_OF_SECOND_FIXED_SURFACE_3 + headerOffSet], pdsValues[POSITION_SCALED_VALUE_OF_SECOND_FIXED_SURFACE_4 + headerOffSet]));
        return template;
    }
}