...
class Grib2DRSReader extends Grib2SectionReader {
    ...
    public Grib2DRS readDRSValues(byte[] drsValues, int headerOffSet) throws GribReaderException {
        ...
        drs.setDataRepresenationtypeNumber(BytesToPrimitiveHelper.asInt(drsValues[POSITION_TEMPLATE_NUMBER1 + headerOffSet],
                drsValues[POSITION_TEMPLATE_NUMBER2 + headerOffSet]));
        drs.setNumberOfDataPoints(BytesToPrimitiveHelper.asInt(
